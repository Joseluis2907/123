...
import static com.example.rlcr.epe1josemunoz.R.layout.activity_credito;
                ...
                if (eteva4.length()<2)
                    ...
                    if (evas4 > 70)
                        ...
                        double suma = cnota1 + cnota2 + cnota3 + cnota4 + cnota5;
                            tvresult.setText(String.format("%.1f", suma/10));
                            //tvresult.setText(Double.toString(suma/10));
...

                        {
                            ...
                            toast3.show();
                            double  promexa=suma*0.7;
                            double preexa=40-promexa;
                            double notaexa=preexa/3;
                            Toast toast6 = Toast.makeText(getBaseContext(),"Necesitas en el examen un "+ String.format("%.1f", notaexa),Toast.LENGTH_LONG);
                            toast6.show();
